      ...
      <div className="w-full max-w-[1400px] flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          {comingSoonMode && !isSignedIn ? (
            <a
              href="#waitlist"
              className="flex items-center gap-2 bg-violet-600 hover:bg-violet-700 dark:bg-[#E8FF4D] dark:hover:bg-[#E8FF4D]/90 text-white dark:text-black text-xs font-bold py-3 px-6 rounded-full transition-all"
            >
              <span className="hidden sm:inline">JOIN WAITLIST</span>
              <div className="w-6 h-6 rounded-full flex items-center justify-center bg-white/20 dark:bg-black/20">
