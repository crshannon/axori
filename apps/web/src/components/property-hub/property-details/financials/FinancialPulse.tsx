 ...
 * Shows: Net Cash Flow, Fixed Opex Burn, Debt Service, Liquid Reserves
 */
    ...
    >
      ...
      <div className="flex-grow flex flex-col justify-center relative z-10">
          ...
          <span className="text-2xl md:text-3xl opacity-30 mr-1">$</span>
            {Math.round(metrics.netCashFlow).toLocaleString()}
          </Typography>
          <Typography
            variant="caption"
          className="text-slate-500 uppercase mt-4 tracking-widest font-bold"
          >
