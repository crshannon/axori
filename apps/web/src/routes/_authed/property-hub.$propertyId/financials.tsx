          ...
          <Card variant="rounded" padding="lg" radius="xl">
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-end border-b border-black/5 dark:border-white/5 pb-4">
                ...
                <p className="text-xl font-black tabular-nums">$312,400</p>
              </div>
              <div className="flex justify-between items-end border-b border-black/5 dark:border-white/5 pb-4">
                <p className="text-[10px] font-black uppercase text-slate-500">
                  Interest Rate
                </p>
                <p className="text-xl font-black tabular-nums">4.25%</p>
              </div>
              <div className="flex justify-between items-end border-b border-black/5 dark:border-white/5 pb-4">
                <p className="text-[10px] font-black uppercase text-slate-500">
                  Maturity Date
                </p>
                <p className="text-xl font-black tabular-nums">11 / 2044</p>
              </div>
              <div className="p-5 rounded-2xl bg-emerald-500/10 border border-emerald-500/20">
                ...
                <p className="text-xs font-bold leading-relaxed">
                  Current LTV: 54%. You have $82k in "Sleepy Equity" that could
                  be redeployed via HELOC.
                </p>
              </div>
            </div>
          </Card>
